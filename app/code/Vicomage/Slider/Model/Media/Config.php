...
namespace Vicomage\Slider\Model\Media;
...
class Config implements ConfigInterface
{
    ...
    {
        return $this->storeManager->getStore()->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA) . 'vicomage/slider';
    }
