 ...
 */
namespace Vicomage\Slider\Controller\Adminhtml\Items\Gallery;
...
class RetrieveImage extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Vicomage\Slider\Model\Media\Config
     */
    ...
    public function __construct(
        ...
        $this->extensionValidator = $extensionValidator
            ?: $this->_objectManager->get(\Magento\MediaStorage\Model\File\Validator\NotProtectedExtension::class);       $this->file = $file;
    }
    ...
    {
        $baseTmpMediaPath = $this->mediaConfig->getBaseMediaPath();
        try {
            ...
            $this->removeImage($localFileFullPath);
        }
    ...
    protected function appendResultSaveRemoteImage($fileName)
    {
        ...
        $result['url'] = $this->mediaConfig->getMediaUrl($tmpFileName);
