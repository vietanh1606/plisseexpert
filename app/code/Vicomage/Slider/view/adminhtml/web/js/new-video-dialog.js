...
define([
    ...
    'Vicomage_Slider/js/get-video-information'
], function ($, _) {
    'use strict';
    ...
    /**
     */
    $.widget('mage.vicomageNewVideoDialog', {
        ...
        _videoTitleInputData: '#video_title',

        _videoDescription: '#video_description',
         ...
         */
        _onUpdate: function () {
            var inputFile, itemId, _inputSelector, mediaFields, imageData, flagChecked, videoTitle, videoDesc, fileName, callback;
            ...
            this.isValid($.proxy(
                function (videoValidStatus) {
                    ...
                    videoTitle = this.element.find(this._videoTitleInputData).val();
                    this._gallery.find('input[name*="video_title"]').val(videoTitle);
                    imageData.video_title = videoTitle;

                    videoDesc = this.element.find(this._videoDescription).val();
                    this._gallery.find('input[name*="video_description"]').val(videoDesc);
                    imageData.video_description = videoDesc;
    ...
    return $.mage.vicomageNewVideoDialog;
});
