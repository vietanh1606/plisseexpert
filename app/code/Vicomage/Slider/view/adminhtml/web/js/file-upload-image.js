    ...
    $.widget('mage.vBaseImages', {
        ...
        _create: function () {
            var $container = this.element,
                ...
                $galleryContainer = $('#vicomage_slider_content_slider_params'),
                mainClass = 'vicomage-base-image',
                maximumImageCount = 5,
            ...
            $container.on('click', '[data-role=make-base-button]', function (event) {
                ...
                $galleryContainer.vicomageSlider('setBase', data);
            });
