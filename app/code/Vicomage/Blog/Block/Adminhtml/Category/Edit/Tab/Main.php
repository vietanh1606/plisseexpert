...
namespace Vicomage\Blog\Block\Adminhtml\Category\Edit\Tab;
    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /* @var $model \Vicomage\Blog\Model\Category */
        $model = $this->_coreRegistry->registry('current_model');

        /*
         * Checking if user have permissions to save information
         */
        $isElementDisabled = !$this->_isAllowedAction('Vicomage_Blog::category');
        ...
        $this->_eventManager->dispatch('Vicomage_blog_category_edit_tab_main_prepare_form', ['form' => $form]);
