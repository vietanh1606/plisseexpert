...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    /**
     * @var \Vicomage\Blog\Model\Config\Source\Category
     */
    protected $_categoryOption;

    /**
     * @var \Vicomage\Blog\Model\Config\Source\Author
     */
     ...
     * @param \Vicomage\Blog\Model\Config\Source\Category $categoryOption
     * @param \Vicomage\Blog\Model\Config\Source\Author $authoryOption
     * @param array $data
     */
    public function __construct(
        ...
        \Vicomage\Blog\Model\Config\Source\Category $categoryOption,
        \Vicomage\Blog\Model\Config\Source\Author $authoryOption,
        array $data = []
    ) {
    ...
    protected function _prepareForm()
    {
        ...
        $this->_eventManager->dispatch('Vicomage_blog_post_edit_tab_main_prepare_form', ['form' => $form]);
