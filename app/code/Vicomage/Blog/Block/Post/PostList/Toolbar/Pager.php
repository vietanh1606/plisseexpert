...
namespace Vicomage\Blog\Block\Post\PostList\Toolbar;

use Vicomage\Blog\Model\Config\Source\LazyLoad;
...
class Pager extends \Magento\Theme\Block\Html\Pager
{
    ...
    public function getLazyloadMode()
    {
        return (int) $this->_scopeConfig->getValue(
            'vicomage_mfblog/post_list/lazyload_enabled',
    ...
    {
        return (int) $this->_scopeConfig->getValue(
            'vicomage_mfblog/post_list/lazyload_padding',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
}
