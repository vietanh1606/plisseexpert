...
abstract class AbstractPost extends \Magento\Framework\View\Element\Template
{
     ...
     * @var string
     */
    protected $_defaultPostInfoBlock = 'Vicomage\Blog\Block\Post\Info';
     ...
     *
     * @return \Vicomage\Blog\Model\Post
     */
    ...
    {
        $post = $this->getPost();
        return $post->getData('short_content');
    }
     ...
     *
     * @return \Vicomage\Blog\Block\Post\Info
     */
