...
class Edit extends \Vicomage\Megamenu\Controller\Adminhtml\Megamenu
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('megamenu_megamenu', $model);
        ...
        $this->_initAction()->_addBreadcrumb(
            ...
            $this->_view->getLayout()->createBlock('Vicomage\Megamenu\Block\Adminhtml\Edit')
        );
