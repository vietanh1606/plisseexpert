 ...
 * Vicomage 
 * @category 	Vicomage 
 * @copyright 	Copyright (c) 2014 Vicomage (http://www.Vicomage.net/) 
 * @license 	http://www.Vicomage.net/license-agreement.html
 * @Author: DOng NGuyen<nguyen@dvn.com>
 * @@Create Date: 2016-03-04 11:44:03
 * @@Modify Date: 2016-03-29 11:47:55
 * @@Function:
 */
namespace Vicomage\Testimonial\Block\Adminhtml\Helper\Renderer\Form;
...
class Summary extends \Magento\Backend\Block\Template
{
    ...
    public function __construct(
		...
		\Vicomage\Testimonial\Model\TestimonialFactory $testimonialFactory,
		array $data = []
    )
    {
