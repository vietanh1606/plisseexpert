...
namespace Vicomage\SearchBox\Block;
...
class SearchBox extends \Magento\Framework\View\Element\Template
{
    ...
    public function _getCfg($attr = null, $data = null)
    {
        ...
        foreach ($groups as $group) {
            $_cfgs = $this->_scopeConfigInterface->getValue('searchbox/' . $group . '',
    ...
    public function _prepareLayout()
    {
        ...
        if ($this->_isAjax()) {
            $template_file = (!empty($template_file)) ? $template_file : "Vicomage_SearchBox::searchbox.form.mini.ajax.phtml";
        } else {
            $template_file = (!empty($template_file)) ? $template_file : "Vicomage_SearchBox::searchbox.form.mini.phtml";
        }
    ...
    {
        $category = $this->_objectManager->create('Vicomage\SearchBox\Model\Config\Source\ListCategories');
